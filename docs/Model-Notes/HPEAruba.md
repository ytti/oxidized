...
The Oxidized model is [ArubaInstant](/lib/oxidized/models/arubainstant.rb).
...
The Oxidized model is [aosw](/lib/oxidized/models/aosw.rb).
...
The Oxidized model is [aoscx](/lib/oxidized/models/aoscx.rb).

## Older Models
Older Devices like [ProCurve](/lib/oxidized/models/procurve.rb) or 3Com/Comware
