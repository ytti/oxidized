...
describe 'Model apc_aos' do
  ...
  it "fetches the configuration with ssh and scp" do
    ...
    model = YAML.load_file('spec/model/data/apcaos#SMT750IC_v2.5.0.8#custom_simulation.yaml')
    ...
    output = File.read('spec/model/data/apcaos#SMT750IC_v2.5.0.8#custom_output.txt')
