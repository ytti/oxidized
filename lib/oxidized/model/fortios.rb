class FortiOS < Oxidized::Model
  ...
  cmd :secret do |cfg|
    cfg.gsub! /(set (?:passwd|password|psksecret|secret|key|group-password|secondary-secret|tertiary-secret|auth-password-l1|auth-password-l2|history0|history1|inter-controller-key ENC)).*/, '\\1 <configuration removed>'
