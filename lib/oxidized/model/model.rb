  ...
  class Model
    ...
    class << self
      ...
      def cmd(cmd_arg = nil, **args, &block)
        ...
        logger.debug "lib/oxidized/model/model.rb Added #{cmd_arg} to the commands list"
      end
    ...
    def cmd(string, &block)
      logger.debug "lib/oxidized/model/model.rb Executing #{string}"
    ...
    def get
      logger.debug 'lib/oxidized/model/model.rb Collecting commands\' outputs'
      outputs = Outputs.new
